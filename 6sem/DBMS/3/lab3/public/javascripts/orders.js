...
// Добавление элемента (СОХРАНЕНО: считывание id_product для MongoDB/Redis)
function addItem(orderId) {
    let data = {
        label: $('#item_label').val(),
        amount: $('#item_amount').val(),
        id_product: $('#item_product').val() // Считываем выбранный из выпадающего списка товар
    };
...
// Проведение оплаты (ИСПРАВЛЕНО: возвращен ваш оригинальный рабочий роут и структура данных)
