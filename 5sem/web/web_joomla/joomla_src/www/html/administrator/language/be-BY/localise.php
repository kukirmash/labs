...
abstract class Be_BYLocalise
{
	...
	public static function getIgnoredSearchWords()
	{
		...
		$search_ignore[] = 'вашыя';
		$search_ignore[] = 'вашым';
		$search_ignore[] = 'вашымі';
		$search_ignore[] = 'вашых';
		$search_ignore[] = 'вашу';
		$search_ignore[] = 'усе';
		$search_ignore[] = 'все-таки';
		$search_ignore[] = 'усялякіх';
		...
		$search_ignore[] = 'все';
		$search_ignore[] = 'усярэдзіну';
		$search_ignore[] = 'все';
		$search_ignore[] = 'таки';
		$search_ignore[] = 'насуперак';
		$search_ignore[] = 'усяго';
		$search_ignore[] = 'далей';
		$search_ignore[] = 'де';
		...
		$search_ignore[] = 'ній';
		$search_ignore[] = 'свой';
		$search_ignore[] = 'іншаму';
		$search_ignore[] = 'іншых';
		$search_ignore[] = 'іншым';
		$search_ignore[] = 'іншага';
		$search_ignore[] = 'іншай';
		$search_ignore[] = 'іншымі';
		$search_ignore[] = 'толькі';
		$search_ignore[] = 'деякі';
		$search_ignore[] = 'поўнаму';
		$search_ignore[] = 'насамперед';
		$search_ignore[] = 'якрамя';
		$search_ignore[] = 'таго';
		$search_ignore[] = 'напярэдадні';
		$search_ignore[] = 'безпасрэдна';
		$search_ignore[] = 'аднак';
		$search_ignore[] = 'ніж';
		$search_ignore[] = 'такім';
		$search_ignore[] = 'чынам';
		...
		$search_ignore[] = 'больш';
		$search_ignore[] = 'перш';
		$search_ignore[] = 'калі-небудзь';
		$search_ignore[] = 'дзе-небудзь';
		$search_ignore[] = 'з-за';
		$search_ignore[] = 'куды-небудзь';
		$search_ignore[] = 'ледзь-ледзь';
		$search_ignore[] = 'чые-небудзь';
		$search_ignore[] = 'чый-небудзь';
		$search_ignore[] = 'чаго-небудзь';
		$search_ignore[] = 'што-небудзь';
		$search_ignore[] = 'як-небудзь';
